...
class Name extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      //or if you didn't set the const above, name would be set to store.getState().name
      category: reduxState.category
      //or if you didn't set the const above, name would be set to store.getState().category
    };
  }
  ...
  saveChanges() {
    ...
    // const {name, category} = this.state; <-- use to destructure this.state from name and category.
    store.dispatch({
      type: UPDATE_NAME,
